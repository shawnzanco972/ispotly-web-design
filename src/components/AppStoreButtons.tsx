...
export function AppStoreButton({ size = "md" }: { size?: Size }) {
  ...
  return (
    <a
      ...
      className={`group inline-flex items-center gap-3 ${s.px} ${s.py} rounded-2xl border border-white/20 bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-white/40 transition`}
    >
